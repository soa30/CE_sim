...
function initfakeCORN()
{
    ...
    typeCen[1+offset] = "cornerborder fix";
    ...
    typeCen[4+offset] = "cornerborder fix";
...
//    print("Moving out of inside complete");
    ...
    drawAllCenters();
    print("Enter loop to move border, corner, and fake cells. Real cells held fixed.");
